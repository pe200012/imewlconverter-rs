...
/// Sina Pinyin format importer
pub struct SinaPinyinImport;

impl SinaPinyinImport {
    pub fn new() -> Self {
        SinaPinyinImport
    }
}

impl Default for SinaPinyinImport {
    fn default() -> Self {
        Self::new()
    }
}

impl WordLibraryTextImport for SinaPinyinImport {
...
impl WordLibraryImport for SinaPinyinImport {
...
mod tests {
    ...
    #[test]
    fn test_import_line() {
        let importer = SinaPinyinImport::new();
    ...
    fn test_import_line_no_rank() {
        let importer = SinaPinyinImport::new();
        let result = importer.import_line("中国\tzhong'guo").unwrap();
